...
export const readFromGoFilesystem = (exports.readFromGoFilesystem = (path) => filesystem[absPath(path)])
export const writeToGoFilesystem = (exports.writeToGoFilesystem = (path, content) => {
...
export const goStdout = (exports.goStdout = (buf) => {})
export const goStderr = (exports.goStderr = (buf) => {})

export const openFiles = new Map()
let nextFd = 1000

export let stat = (path, callback) => {
    let mode = 0
    if (path === "/") {
        mode |= 0x80000000
...
let outputBuf = ""
export const fs = (exports.fs = {
    constants,
    writeSync(fd, buf) {
        if (fd === 1) {
            exports.goStdout(buf)
        } else if (fd === 2) {
            exports.goStderr(buf)
        } else {
...
export const process = (exports.process = {
    cwd() {
        console.log("cwd()")
...
export const Go = (exports.Go = class {
    constructor() {
        this.argv = ["js"]
        this.env = {}
        this.exit = (code) => {
